...
public class GameLayer extends CCLayer{
	...
	public GameLayer(){
		...
		CGPoint LBPosition = CGPoint.ccp(250, 100);
		CGPoint RBPosition = CGPoint.ccp(750, 100);
	...
	public boolean ccTouchesBegan(MotionEvent event) {
		...
		CGPoint jumpDownVec = CGPoint.ccp(0, -200);
		CCMoveBy moveUp = CCMoveBy.action(0.5f, jumpUpVec);
		CCMoveBy moveDown = CCMoveBy.action(0.5f, jumpDownVec);
