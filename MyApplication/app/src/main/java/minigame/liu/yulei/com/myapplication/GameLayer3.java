...
//		addChild(emitter11,9);
		...
		ccTimer = CCProgressTimer.progress("HealthBar.png");
		ccTimer.setType(ccTimer.kCCProgressTimerTypeHorizontalBarLR);
		ccTimer.setPercentage(100);
		ccTimer.setPosition(CGPoint.ccp(1000f, 500f));
		ccTimer.setScale(3.0f);
		addChild(ccTimer,17);
